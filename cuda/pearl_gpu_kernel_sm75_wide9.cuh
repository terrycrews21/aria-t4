// ariaminer — Turing sm_75 variant: chunkK=64, stride 20, 2 stages, dynamic smem
// Transcripts in global memory to save smem space.
// No bank conflicts with stride 20 for chunkK=64.
#pragma once
...
static constexpr int kRowStride = 20;  // padded for bank-conflict-free with chunkK=64
static constexpr int kWordsA = kBlockM * kRowStride;   // 2560 words
static constexpr int kWordsB = kBlockN * kRowStride;   // 5120 words
static constexpr int kWordsStage = kWordsA + kWordsB;  // 7680 words = 30720 bytes
static constexpr int kStages = 2;
static constexpr int kDynamicSmemBytes = kStages * kWordsStage * 4;  // 61440 bytes
...
void grind(const int8_t* __restrict__ a,
  ...
  uint32_t* my_trans = transcript_buf + 
  ...
  // A: 128 rows x 4 uint4 = 512 loads; B: 256 rows x 4 uint4 = 1024 loads
